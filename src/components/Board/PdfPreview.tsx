...
//         for (
//           let pageNumber = 1;
//           pageNumber <= (firstPageOnly ? 1 : pdf.numPages);
//           pageNumber++
//         ) {
//           if (cancelled) break;
...
//     return (
//       <div
//         className={`flex items-center justify-center bg-neutral-900 text-xs text-neutral-500 ${className}`}
//       >
//         Failed to load PDF
//       </div>
//     );
...
//   return (
//     <div className={`relative overflow-y-auto bg-neutral-900 ${className}`}>
//       {loading && (
